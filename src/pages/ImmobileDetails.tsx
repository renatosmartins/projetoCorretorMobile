...
interface ImmobileDetailsRouteParams {
  id: number;
}
...
export default function ImmobileDetails() {
  ...
  const params = route.params as ImmobileDetailsRouteParams;
  ...
  function handleOpenGoogleMapsRoutes(){
    Linking.openURL(`https://www.google.com/maps/dir/?api=1&destination=${immobile?.latitude}, ${immobile?.longitude}`)
  }
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        <Text style={styles.title}>{immobile.name}</Text>
        ...
        <Text style={styles.description}>
          { immobile.instructions }
        </Text>

        <View style={styles.scheduleContainer}>
          <View style={[styles.scheduleItem, styles.scheduleItemBlue]}>
            <Feather name="clock" size={40} color="#2AB5D1" />
            <Text style={[styles.scheduleText, styles.scheduleTextBlue]}>Segunda à Sexta {immobile.opening_hours}</Text>
          </View>
